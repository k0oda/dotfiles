...
hl.bind("SUPER + CTRL + U", hl.dsp.window.move({ workspace = "r+1" }))
hl.bind("SUPER + CTRL + I", hl.dsp.window.move({ workspace = "r-1" }))
...
hl.bind("SUPER + SHIFT + mouse_down", hl.dsp.window.cycle_next({ next = false }))
hl.bind("SUPER + SHIFT + mouse_up", hl.dsp.window.cycle_next({ next = true }))
...
hl.bind("SUPER + CTRL + SHIFT + mouse_down", hl.dsp.window.swap({ next = true }))
